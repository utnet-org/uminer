...
func (alwaysDenyUI) OnApprovedTx(tx uncapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx uncapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(uncapi.SignTransactionResult{})
...
func TestLimitWindow(t *testing.T) {
	...
	// 0.3 unicrpyt: 429D069189E0000 wei
	...
	for i := 0; i < 3; i++ {
		...
		response := uncapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx uncapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
