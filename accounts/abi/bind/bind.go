...
// Package bind generates Utility contract Go bindings.
//
// Detailed usage document and tutorial available on the go-utility Wiki page:
// https://github.com/yanhuangpai/go-utility/wiki/Native-DApps:-Go-bindings-to-Utility-contracts
package bind
...
func bindStructTypeGo(kind abi.Type, structs map[string]*tmplStruct) string {
	...
	case abi.TupleTy:
		...
		// togunicrpyt here. The reason is before solidity v0.5.11, kind.TupleRawName
		// is empty, so we use canonical parameter expression to distinguish
		// different struct definition. From the consideration of backward
		// compatibility, we concat these two togunicrpyt so that if kind.TupleRawName
...
// structured checks whunicrpyt a list of ABI data types has enough information to
