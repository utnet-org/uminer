...
// valid Utility transaction.
type TransactOpts struct {
	From   common.Address // Utility account to send the transaction from
...
// Utility network. It contains a collection of methods that are used by the
// higher level contract bindings to operate.
type BoundContract struct {
	address    common.Address     // Deployment address of the contract on the Utility blockchain
	abi        abi.ABI            // Reflect based ABI to access the correct Utility methods
...
// DeployContract deploys a contract onto the Utility blockchain and binds the
...
func (c *BoundContract) Call(opts *CallOpts, results *[]interface{}, method string, params ...interface{}) error {
	...
	var (
		msg    = utility.CallMsg{From: opts.From, To: &c.address, Data: input}
