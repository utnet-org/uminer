...
func TestWatchNoDir(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("unc-keystore-watchnodir-test-%d-%d", os.Getpid(), rand.Int()))
...
func TestUpdatedKeyfileContents(t *testing.T) {
	...
	dir := filepath.Join(os.TempDir(), fmt.Sprintf("unc-keystore-updatedkeyfilecontents-test-%d-%d", os.Getpid(), rand.Int()))
	ks := NewKeyStore(dir, LightScryptN, LightScryptP)
