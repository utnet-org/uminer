...
func NewPruner(db uncdb.Database, config Config) (*Pruner, error) {
...
func prune(snaptree *snapshot.Tree, root common.Hash, maindb uncdb.Database, stateBloom *stateBloom, bloomPath string, middleStateRoots map[common.Hash]struct{}, start time.Time) error {
...
// in the disk.
func RecoverPruning(datadir string, db uncdb.Database) error {
...
func extractGenesis(db uncdb.Database, stateBloom *stateBloom) error {
