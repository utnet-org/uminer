...
// stateObject represents an Utility account which is being modified.
//
...
type stateObject struct {
	db       *StateDB
	address  common.Address      // address of utility account
	addrHash common.Hash         // hash of utility address of the account
	...
	// Flag if the account was marked as self-destructed. The self-destructed account
	// is still accessible in the scope of same transaction.
	selfDestructed bool

	// Flag if the account was marked as deleted. A self-destructed account
	// or an account that is considered as empty will be marked as deleted at
	// the end of transaction and no longer accessible anymore.
	deleted bool

	// Flag if the object was created in the current transaction
	created bool
}
