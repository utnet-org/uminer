...
// Package types contains data types related to Utility consensus.
package types
...
// Header represents a block header in the Utility blockchain.
type Header struct {
...
// a block's data contents (transactions and uncles) jointly.
type Body struct {
...
type Block struct {
	...
	// These fields are used by package unc to track
	// inter-peer block relay.
	ReceivedAt   time.Time
	ReceivedFrom interface{}
}

// "external" block encoding. used for unc protocol, etc.
