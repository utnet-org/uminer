...
func (bc *testBlockChain) CurrentBlock() *types.Header {
	...
	// The base fee at 5714 UNC translates into the 21000 base gas higher than
	// mainnet unicrpyt existence, use that as a cap for the tests.
	var (
	...
	// unicrpyt existence, use that as a cap for the tests.
	lo = new(big.Int)
