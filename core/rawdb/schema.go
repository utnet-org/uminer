...
var (
	...
	configPrefix   = []byte("utility-config-")  // config prefix for the db
	genesisPrefix  = []byte("utility-genesis-") // genesis state prefix for the db
...
// IsLegacyTrieNode reports if a provided database entry is a legacy trie
...
// ResolveAccountTrieNodeKey reports if a provided database entry is an
...
// IsAccountTrieNode reports if a provided database entry is an account
...
// ResolveStorageTrieNode reports if a provided database entry is a storage
...
// IsStorageTrieNode reports if a provided database entry is a storage
// trie node in path-based state scheme.
