...
func ReadSnapshotDisabled(db uncdb.KeyValueReader) bool {
	disabled, _ := db.Has(snapshotDisabledKey)
	return disabled
}

// WriteSnapshotDisabled stores the snapshot pause flag.
func WriteSnapshotDisabled(db uncdb.KeyValueWriter) {
...
func DeleteSnapshotDisabled(db uncdb.KeyValueWriter) {
...
func ReadSnapshotRoot(db uncdb.KeyValueReader) common.Hash {
...
// the persisted snapshot.
func WriteSnapshotRoot(db uncdb.KeyValueWriter, root common.Hash) {
...
// invalid.
func DeleteSnapshotRoot(db uncdb.KeyValueWriter) {
...
func ReadAccountSnapshot(db uncdb.KeyValueReader, hash common.Hash) []byte {
	data, _ := db.Get(accountSnapshotKey(hash))
	return data
}

// WriteAccountSnapshot stores the snapshot entry of an account trie leaf.
func WriteAccountSnapshot(db uncdb.KeyValueWriter, hash common.Hash, entry []byte) {
...
func DeleteAccountSnapshot(db uncdb.KeyValueWriter, hash common.Hash) {
...
func ReadStorageSnapshot(db uncdb.KeyValueReader, accountHash, storageHash common.Hash) []byte {
	data, _ := db.Get(storageSnapshotKey(accountHash, storageHash))
	return data
}

// WriteStorageSnapshot stores the snapshot entry of an storage trie leaf.
func WriteStorageSnapshot(db uncdb.KeyValueWriter, accountHash, storageHash common.Hash, entry []byte) {
...
func DeleteStorageSnapshot(db uncdb.KeyValueWriter, accountHash, storageHash common.Hash) {
...
func IterateStorageSnapshots(db uncdb.Iteratee, accountHash common.Hash) uncdb.Iterator {
...
func ReadSnapshotJournal(db uncdb.KeyValueReader) []byte {
...
func WriteSnapshotJournal(db uncdb.KeyValueWriter, journal []byte) {
...
// the last shutdown
func DeleteSnapshotJournal(db uncdb.KeyValueWriter) {
...
// the last shutdown.
func ReadSnapshotGenerator(db uncdb.KeyValueReader) []byte {
...
// shutdown.
func WriteSnapshotGenerator(db uncdb.KeyValueWriter, generator []byte) {
...
// the last shutdown
func DeleteSnapshotGenerator(db uncdb.KeyValueWriter) {
...
// snapshot layer.
func ReadSnapshotRecoveryNumber(db uncdb.KeyValueReader) *uint64 {
...
// snapshot layer.
func WriteSnapshotRecoveryNumber(db uncdb.KeyValueWriter, number uint64) {
	var buf [8]byte
...
// snapshot layer.
func DeleteSnapshotRecoveryNumber(db uncdb.KeyValueWriter) {
...
func ReadSnapshotSyncStatus(db uncdb.KeyValueReader) []byte {
	data, _ := db.Get(snapshotSyncStatusKey)
	return data
}

// WriteSnapshotSyncStatus stores the serialized sync status to save at shutdown.
func WriteSnapshotSyncStatus(db uncdb.KeyValueWriter, status []byte) {
