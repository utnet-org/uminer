...
func NewTable(db uncdb.Database, prefix string) uncdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) ModifyAncients(fn func(uncdb.AncientWriteOp) error) (int64, error) {
	return t.db.ModifyAncients(fn)
}

func (t *table) ReadAncients(fn func(reader uncdb.AncientReaderOp) error) (err error) {
...
func (t *table) NewIterator(prefix []byte, start []byte) uncdb.Iterator {
...
func (t *table) NewBatch() uncdb.Batch {
	return &tableBatch{t.db.NewBatch(), t.prefix}
}

// NewBatchWithSize creates a write-only database batch with pre-allocated buffer.
func (t *table) NewBatchWithSize(size int) uncdb.Batch {
...
func (t *table) NewSnapshot() (uncdb.Snapshot, error) {
...
func (b *tableBatch) Replay(w uncdb.KeyValueWriter) error {
