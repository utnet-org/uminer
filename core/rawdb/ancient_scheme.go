...
// chainFreezerNoSnappy configures if compression is disabled for the ancient-tables.
...
func NewStateFreezer(ancientDir string, readOnly bool) (*ResettableFreezer, error) {
	return NewResettableFreezer(filepath.Join(ancientDir, stateFreezerName), "unc/db/state", readOnly, stateHistoryTableSize, stateFreezerNoSnappy)
}
