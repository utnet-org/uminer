...
// Package forkid implements EIP-2124 (https://eips.utility.org/EIPS/eip-2124).
package forkid
...
// timestampThreshold is the Utility mainnet genesis timestamp. It is used to
...
// NewID calculates the Utility fork ID from the chain config, genesis hash, head and time.
...
// NewIDWithChain calculates the Utility fork ID from an existing chain instance.
