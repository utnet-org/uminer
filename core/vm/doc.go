...
/*
Package vm implements the Utility Virtual Machine.

The vm package implements one UVM, a byte code VM. The BC (Byte Code) VM loops
over a set of bytes and executes them according to the set of rules defined
in the Utility yellow paper.
*/
package vm
