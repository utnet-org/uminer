...
//
// Account references are used during UVM initialisation and
...
// Contract represents an utility contract in the state database. It contains
...
// NewContract returns a new contract environment for the execution of UVM.
