...
// It can be used for testing that restart Gunc normally.
...
// It can be used for testing that restart Gunc after the crash.
...
// Tests a Gunc restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gunc was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gunc was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gunc was running with snapshot enabled. Then restarts without
...
// Tests the Gunc was running with snapshot enabled and resetHead is applied.
...
// Tests the Gunc was running with a complete snapshot and then imports a few
