...
// Package asm provides support for dealing with UVM assembly instructions (e.g., disassembling them).
package asm
...
// Iterator for disassembled UVM instructions
...
// PrintDisassembled pretty-print all disassembled UVM instructions to stdout.
...
// Disassemble returns all disassembled UVM instructions in human-readable format.
