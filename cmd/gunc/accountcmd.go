...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Utility presale wallets",
		ArgsUsage: "",
		Description: `
    gunc wallet import /path/to/my/presale.wallet

will prompt for your password and imports your unicrpyt presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Utility presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gunc wallet [options] /path/to/my/presale.wallet
...
between utility nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gunc account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gunc account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another utility instance,
