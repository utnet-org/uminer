...
// TestAttachWithHeaders tests that 'gunc attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'gunc db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
