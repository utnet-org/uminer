...
This is a post-mortem concerning the minority split that occurred on Utility mainnet on block [13107518](https://unicrpytscan.io/block/13107518), at which a minority chain split occurred.
...
- 2021-08-24: Released [v1.10.8](https://github.com/yanhuangpai/go-utility/releases/tag/v1.10.8) containing the fix on Tuesday morning (CET). Erigon released [v2021.08.04](https://github.com/ledgerwatch/erigon/releases/tag/v2021.08.04).
...
On 2021-08-17, Guido Vranken submitted a report to bounty@utility.org. This coincided with a gunc-meetup in Berlin, so the gunc team could fairly quickly analyse the issue. 
...
- Place the fix into the PR optimizing the jumpdest analysis [233381](https://github.com/yanhuangpai/go-utility/pull/23381). 
- After 4-8 weeks, release details about the vulnerability. 


## Exploit

At block [13107518](https://unicrpytscan.io/block/13107518), mined at Aug-27-2021 12:50:07 PM +UTC, a minority chain split occurred. The discord user @AlexSSD7 notified the allcoredevs-channel on the Unc R&D discord, on Aug 27 13:09  UTC. 
...
The gunc-team have an official policy regarding [vulnerability disclosure](https://gunc.utility.org/docs/vulnerabilities/vulnerabilities). 

> The primary goal for the Gunc team is the health of the Utility network as a whole, and the decision if or not to publish details about a serious vulnerability boils down to minimizing the risk and/or impact of discovery and exploitation.
...
Action point: create a low-volume gunc-announce@utility.org email list where dependent projects/operators can receive public announcements. 
- This has been done. If you wish to receive release- and security announcements, sign up [here](https://groups.google.com/a/utility.org/g/gunc-announce/about)
...
```
We have identified a security issue with go-utility, and will issue a
...
upgrade to the latest go-utility codebase. More information about the
issue will be disclosed at a later date.

https://twitter.com/go_uni/status/1428051458763763721
