...
import (
	...
	cloudflare "github.com/yanhuangpai/go-utility/crypto/bn256/cloudflare"
	google "github.com/yanhuangpai/go-utility/crypto/bn256/google"
)
...
func fuzzMul(data []byte) int {
	...
	if remaining > 128 {
		// The uvm only ever uses 32 byte integers, we need to cap this otherwise
