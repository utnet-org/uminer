...
# 1. install gunc for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gunc
# 5. create gunc, attach and uninstall start menu entries
...
!define GROUPNAME "Utility"
!define APPNAME "Gunc"
!define DESCRIPTION "Official Go implementation of the Utility protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gunc is installed global
