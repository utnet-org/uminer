...
We want to build go-utility with the most recent version of Go, irrespective of the Go
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/utility-unstable-1.9.6+bionic
    $ dpkg-buildpackage

Built packages are placed in the dist/ directory.

    $ cd ..
    $ dpkg-deb -c gunc-unstable_1.9.6+bionic_amd64.deb
