Name "gunc ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/yanhuangpai/go-utility/issues"
!define UPDATEURL "https://github.com/yanhuangpai/go-utility/releases"
!define ABOUTURL "https://github.com/yanhuangpai/go-utility#utility-go"
...
# Install gunc binary
Section "Gunc" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gunc}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gunc.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gunc.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gunc incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gunc outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gunc UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gunc incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gunc.exe" "" "" "Utility" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gunc outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gunc.exe" "" "" "Utility" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gunc UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gunc.exe" "" "" "Utility" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gunc.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gunc.ipc"
