...
// usecolor defines if the CLI help should use colored output or normal dumb
...
// Example:
//
//	gunc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
//	gunc --keystore /tmp/mykeystore --lightkdf account new
//
