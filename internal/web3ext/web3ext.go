...
// Package web3ext contains gunc specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		new web3._extend.Method({
			name: 'changeSuperAccount',
			call: 'coffer_changeSuperAccount',
			params: 2
		}),
		new web3._extend.Method({
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: 'unc_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'fillTransaction',
			call: 'unc_fillTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getHeaderByNumber',
			call: 'unc_getHeaderByNumber',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'getHeaderByHash',
			call: 'unc_getHeaderByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getBlockByNumber',
			call: 'unc_getBlockByNumber',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter, function (val) { return !!val; }]
		}),
		new web3._extend.Method({
			name: 'getBlockByHash',
			call: 'unc_getBlockByHash',
			params: 2,
			inputFormatter: [null, function (val) { return !!val; }]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'unc_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'unc_getRawTransactionByBlockHashAndIndex' : 'unc_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'unc_pendingTransactions',
		...
		new web3._extend.Property({
			...
			getter: 'unc_maxPriorityFeePerGas',
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			name: 'setUnicrpytbase',
			call: 'miner_setUnicrpytbase',
			params: 1,
