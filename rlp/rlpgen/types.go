...
// nonZeroCheck returns the expression that checks if 'v' is a non-zero value of type 'vtyp'.
...
// isBigInt checks if 'typ' is "math/big".Int.
...
// isUint256 checks if 'typ' is "github.com/holiman/uint256".Int.
...
// isByte checks if the underlying type of 'typ' is uint8.
