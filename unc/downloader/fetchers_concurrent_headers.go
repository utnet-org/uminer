...
func (q *headerQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *unc.Response) (*unc.Request, error) {
...
func (q *headerQueue) deliver(peer *peerConnection, packet *unc.Response) (int, error) {
	headers := *packet.Res.(*unc.BlockHeadersRequest)
