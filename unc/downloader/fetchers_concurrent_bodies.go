...
func (q *bodyQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *unc.Response) (*unc.Request, error) {
...
func (q *bodyQueue) deliver(peer *peerConnection, packet *unc.Response) (int, error) {
	txs, uncles, withdrawals := packet.Res.(*unc.BlockBodiesResponse).Unpack()
