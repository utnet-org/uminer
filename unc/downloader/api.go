...
// Syncing provides information when this nodes starts synchronising with the Utility network and when it's finished.
...
type SyncingResult struct {
	...
	Status  utility.SyncProgress `json:"status"`
}
