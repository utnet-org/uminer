...
func (q *receiptQueue) request(peer *peerConnection, req *fetchRequest, resCh chan *unc.Response) (*unc.Request, error) {
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *unc.Response) (int, error) {
	receipts := *packet.Res.(*unc.ReceiptsResponse)
