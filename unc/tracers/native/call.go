...
type callLog struct {
	...
	// See https://github.com/yanhuangpai/go-utility/pull/28389 for details
...
func (t *callTracer) CaptureStart(env *vm.UVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	toCopy := to
