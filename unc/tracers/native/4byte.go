...
// isPrecompiled returns if the addr is a precompile. Logic borrowed from newJsTracer in unc/tracers/js/tracer.go
...
func (t *fourByteTracer) CaptureStart(env *vm.UVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
