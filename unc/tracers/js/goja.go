...
import (
	...
	jsassets "github.com/yanhuangpai/go-utility/unc/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-utility.
func init() {
	var err error
...
// `enter` and `exit` always go jointly.
