...
// ProtocolName is the official short name of the `unc` protocol used during
// devp2p capability negotiation.
const ProtocolName = "unc"

// ProtocolVersions are the supported versions of the `unc` protocol (first
// is primary).
...
// Packet represents a p2p message in the `unc` protocol.
...
// NewPooledTransactionHashesPacket67 represents a transaction announcement packet on unc/67.
type NewPooledTransactionHashesPacket67 []common.Hash

// NewPooledTransactionHashesPacket68 represents a transaction announcement packet on unc/68 and newer.
