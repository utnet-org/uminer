...
import "github.com/yanhuangpai/go-utility/metrics"
...
func init() {
	meters = bidirectionalMeters{
		ingress: newHandshakeMeters("unc/protocols/unc/ingress/handshake/"),
		egress:  newHandshakeMeters("unc/protocols/unc/egress/handshake/"),
	}
}
