...
// SetUnicrpytbase sets the unicrpytbase of the miner.
func (api *MinerAPI) SetUnicrpytbase(unicrpytbase common.Address) bool {
	api.e.SetUnicrpytbase(unicrpytbase)
	return true
}
