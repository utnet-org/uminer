...
// FullSyncTester is an auxiliary service that allows Gunc to perform full sync
...
func RegisterFullSyncTester(stack *node.Node, backend *unc.Utility, target common.Hash) (*FullSyncTester, error) {
	cl := &FullSyncTester{
		stack:   stack,
		backend: backend,
		target:  target,
