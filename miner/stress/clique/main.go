...
func makeSealer(genesis *core.Genesis) (*node.Node, *unc.Utility, error) {
	// Define the basic configurations for the Utility node
	...
	// Start the node and configure a full Utility node on it
