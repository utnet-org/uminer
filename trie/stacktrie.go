...
type StackTrieOptions struct {
	...
	SkipLeftBoundary  bool          // Flag if the nodes on the left boundary are skipped for committing
	SkipRightBoundary bool          // Flag if the nodes on the right boundary are skipped for committing
...
// WithSkipBoundary configures if the left and right boundary nodes are
