...
func (s *spongeDb) NewBatch() uncdb.Batch                    { return &spongeBatch{s} }
func (s *spongeDb) NewBatchWithSize(size int) uncdb.Batch    { return &spongeBatch{s} }
func (s *spongeDb) NewSnapshot() (uncdb.Snapshot, error)     { panic("implement me") }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) uncdb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w uncdb.KeyValueWriter) error { return nil }
