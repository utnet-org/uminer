...
// Trie is an Utility state trie, can be implemented by Utility Merkle Patricia
// tree or Verkle tree.
type Trie interface {
...
type Set struct {
	...
	Incomplete map[common.Address]struct{}               // Indicator if the storage is incomplete due to large deletion
