...
type Config struct {
	...
	ReadOnly       bool   // Flag if the database is opened in read only mode.
}
...
// Defaults contains default settings for Utility mainnet.
var Defaults = &Config{
...
type Database struct {
	// readOnly is the flag if the mutation is allowed to be applied.
