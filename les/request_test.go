...
type accessTestFn func(db uncdb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db uncdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db uncdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db uncdb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db uncdb.Database, bhash common.Hash, num uint64) light.OdrRequest {
