...
// algorithm. There is a special flag inside to decide if to use legacy consensus
...
// stock Utility consensus engine.
...
// rules of the Utility consensus engine.
...
// verifyHeader checks if a header conforms to the consensus rules of the
// stock Utility consensus engine. The difference between the beacon and classic is
