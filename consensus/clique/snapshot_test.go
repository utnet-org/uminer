...
// mapped from textual names used in the tests below to actual Utility private
...
// address retrieves the Utility address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Utility address
	...
	tests := []cliqueTest{
		{
			...
			// batch (https://github.com/yanhuangpai/go-utility/issues/17593). Whilst this
