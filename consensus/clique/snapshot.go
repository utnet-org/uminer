...
func loadSnapshot(config *params.CliqueConfig, sigcache *sigLRU, db uncdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db uncdb.Database) error {
