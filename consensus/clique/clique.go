...
import (
	...
	lru "github.com/yanhuangpai/go-utility/common/lru"
...
// ecrecover extracts the Utility account address from a signed header.
func ecrecover(header *types.Header, sigcache *sigLRU) (common.Address, error) {
	...
	// Recover the public key and the Utility address
...
// Utility testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     uncdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Utility address of the signing key
...
func New(config *params.CliqueConfig, db uncdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Utility address recovered
