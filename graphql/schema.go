...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Utility address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Utility account at a particular block.
    type Account {
    ...
    # Transaction is an Utility transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Utility account at the current block's state.
    ...
    type Pending {
        ...
        transactions: [Transaction!]
        # Account fetches an Utility account for the pending state.
        account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Utility block by number or by hash. If neither is
