...
func New(stack *node.Node, backend uncapi.Backend, filterSystem *filters.FilterSystem, cors, vhosts []string) error {
...
func newHandler(stack *node.Node, backend uncapi.Backend, filterSystem *filters.FilterSystem, cors, vhosts []string) (*handler, error) {
