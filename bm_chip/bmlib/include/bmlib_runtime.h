...
/**
 * @name    bmcpu_gen_aes_key
 * @brief   generate aeskey in bmcpu and program aes key to efuse 
 * @ingroup bmlib_log
 *
 * @param [in]  handle          The device handle
 * 
 ...
 *          Other code  Fails.
 */
DECL_EXPORT bm_status_t bmcpu_gen_aes_key(bm_handle_t handle);

/**
 * @name    bmcpu_gen_p2_pubkey
 * @brief   get p2 and public key from device
 * @ingroup bmlib_log
 *
 * @param [in]  handle          The device handle
 * @param [in]  p2              p2 key
 * @param [in]  size_p2         size of p2 key
 * @param [in]  pubkey          public key
 * @param [in]  size_pubkey     size of public key
 * 
 * @retval  BM_SUCCESS  Succeeds.
 *          Other code  Fails.
 */
DECL_EXPORT bm_status_t bmcpu_gen_p2_pubkey(bm_handle_t handle, unsigned char* p2, unsigned int* size_p2, 
                                              unsigned char* pubkey, unsigned int* size_pubkey);
 ...
 * @param [in]  size_signature  size of signature
 * @param [in]  digest          digest 
 * @param [in]  size_digest     size of digest
 * @param [in]  p2              p2 key
 * @param [in]  size_p2         size of public key
 * 
 * @retval  BM_SUCCESS  Succeeds.
 *          Other code  Fails.
 */
DECL_EXPORT bm_status_t bmcpu_gen_sign(bm_handle_t  handle, unsigned char* signature, unsigned int* size_signature, 
                                    unsigned char* digest, unsigned int size_digest, unsigned char* p2,unsigned int size_p2);
