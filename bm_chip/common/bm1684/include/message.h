...
//  BM_API_ID_TANH_FWD_PARALLEL                = 63,
  ...
  BM_API_ID_CV_BITWISE                       = 534,
  BM_API_ID_CV_CONVERT_TO_ROI                = 535,
  ...
  BM_API_ID_GEN_P2_PUBKEY = 0x8000000c,
  BM_API_ID_GEN_SIGN = 0x8000000d,
  BM_API_ID_GEN_AES_KEY = 0X8000000e,
  BM_API_ID_CPU_MAX,
} bm_api_id_t;
