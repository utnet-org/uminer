...
// Package p2p implements the Utility p2p network protocols.
package p2p
...
import (
	...
	"github.com/yanhuangpai/go-utility/p2p/discover"
...
type Config struct {
	...
	// DiscoveryV4 specifies if V4 discovery should be started.
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Utility Node Record
