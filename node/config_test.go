...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gunc.ipc", false, filepath.Join(os.TempDir(), "gunc.ipc")},
		{"data", "gunc.ipc", false, "data/gunc.ipc"},
		{"data", "./gunc.ipc", false, "./gunc.ipc"},
		{"data", "/gunc.ipc", false, "/gunc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gunc.ipc", true, `\\.\pipe\gunc.ipc`},
		{"data", "gunc.ipc", true, `\\.\pipe\gunc.ipc`},
		{"data", `\\.\pipe\gunc.ipc`, true, `\\.\pipe\gunc.ipc`},
	}
