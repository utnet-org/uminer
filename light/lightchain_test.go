...
func makeHeaderChain(parent *types.Header, n int, db uncdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (uncdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() uncdb.Database {
	return odr.db
}
