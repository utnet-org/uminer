...
// Package utility defines interfaces for interacting with Utility.
package utility
...
type SyncProgress struct {
	...
	// "fast sync" fields. These used to be sent by gunc, but are no longer used
	// since version v1.10.
...
// the UVM but not mined into the blockchain. ContractCall is a low-level method to
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by unc_getLogs, return logs only from block with this hash
