...
const (
	...
	subscribeTimeout   = 10 * time.Second // overall timeout unc_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscription under the "unc" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "unc", channel, args...)
}
...
// SupportsSubscriptions reports if subscriptions are supported by the client
